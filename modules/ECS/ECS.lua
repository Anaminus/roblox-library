...
--@sec: ECS
--@ord: -1
--@doc: ESC is an implementation of the entity-component-system pattern.
--
-- ## Synopsis
-- ```lua
...
--@doc: Name is a string that must be a valid Lua identifier.

--@sec: World
--@def: type World
--@doc: World is a collection of entities, components, and systems.
local World = {__index={}}

--@sec: WorldState
--@def: type WorldState
--@doc: WorldState encapsulates the state of a World.
local WorldState = {__index={}}

--@sec: ID
--@def: type ID = _entity_id_
--@doc: ID uniquely identifies an entity in a particular World. It is valid for
...
--}
--@doc: Entity represents the state of a single entity.

--@sec: WorldState.Entity
--@def: WorldState:Entity(target: ID): Entity?
--@doc: Entity returns the state of the entity of the given identifier. Returns
...
--@sec: Updater
--@def: type Updater = (world: WorldState, entities: Array<Entity>, args: ...any) -> ()
--@doc: Updater is passed to World.DefineSystem, and is called when the
...
--@sec: World.DefineSystem
--@def: World:DefineSystem(name: Name, components: Array<string>, update: Updater)
--@doc: DefineSystem defines a system in the world.
--
...
--@sec: ComponentDef
--@def: type ComponentDef = any
--@doc: ComponentDef determines the value of a component.

--@sec: DynComponentDef
--@def: type DynComponentDef = function(args: ...any): (component: ComponentDef)
--@doc: DynComponentDef defines the value of a component dynamically.
--
...
--@sec: World.DefineComponent
--@def: World:DefineComponent(name: Name, def: DynComponentDef|ComponentDef)
--@doc: DefineComponent defines a component in the world.
--
...
--@sec: EntityDef
--@def: type EntityDef = Dictionary<string, ({[number]: any, n: number?}|boolean)>
--@doc: EntityDef defines and initializes the components of an entity type.
--
...
--@sec:DynEntityDef
--@def: type DynEntityDef = function(args: ...any): (entity: EntityDef)
--@doc: DynEntityDef defines the components of an entity type and initializes
...
--@sec: World.DefineEntity
--@def: World:DefineEntity(name: Name, def: DynEntityDef|EntityDef)
--@doc: DefineEntity defines an entity type in the world. An entity type
...
--@sec: World.Init
--@def: function World:Init()
--@doc: Init initializes the world. After initialization, entity types,
...
--@sec: World.CreateEntity
--@def: World:CreateEntity(name: Name, args: ...any): (entity: ID)
--@doc: CreateEntity creates a new entity in the world.
--
...
--@sec: World.DestroyEntity
--@def: World:DestroyEntity(entity: ...ID)
--@doc: DestroyEntity marks a number of entities to be removed from the world.
--
-- Throws an error before the world is initialized.
...
--@sec: World.Upkeep
--@def: World:Upkeep()
--@doc: Upkeep performs maintenance. This should be called at an appropriate
...
--@sec: World.Update
--@def: World:Update(system: Name, args: ...any)
--@doc: Update updates a system.
--
...
--@sec: World.Has
--@def: World:Has(entity: ID, component: Name?): boolean
--@doc: Has returns whether the entity of the given ID exists in the world. If
...
--@sec: World.Get
--@def: World:Get(entity: ID, component: Name): any?
--@doc: Get returns the value of an entity's component. Returns nil if the
...
--@sec: World.Set
--@def: World:Set(entity: ID, component: Name, value: any): boolean
--@doc: Set sets the value of an entity's component, returning true on success.
...
-- }
--@doc: Handle is a reference to an entity within a World. The entity may or may
-- not exist.
local Handle = {}

--@sec: World.Handle
--@def: World:Handle(entity: ID): Handle
--@doc: Handle returns a Handle that refers to the entity. The entity may or may
-- not exist.
...
--@sec: Handle.\__call {Handle.__call}
--@def: Handle(component: Name?): boolean
--@doc: Returns whether the entity exists, or whether the entity has the
...
--@sec: Handle.\__index {Handle.__index}
--@def: Handle[Name]: any
--@doc: Returns the value of the entity's component. Behaves the same as
-- World.Get.
function Handle:__index(k)
	return rawget(self, "World"):Get(rawget(self, "ID"), k)
end

--@sec: Handle.\__newindex {Handle.__newindex}
--@def: Handle[Name] = any
--@doc: Sets the value of the entity's component. Behaves the same as World.Set.
